...
public class TBDSNode {
  ...
  public HashMap<Character, TBDSNode> getChildren(){ return children; }
  public void addChildren(char character){ children.put(character,new TBDSNode()); }//adds child in hashmap with new TBDSNode at character key
}